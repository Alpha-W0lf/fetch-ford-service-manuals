...
| 04 | [2026-07-08_dev_guide_04_orchestrator_split.md](./2026-07-08_dev_guide_04_orchestrator_split.md) | Major refactor | **Executed** (soak pending) | **No** (during impl) |
| 05 | [2026-07-08_dev_guide_05_capture_modularization.md](./2026-07-08_dev_guide_05_capture_modularization.md) | Refactor | **Ready** (capture must stop) | Yes (bulk can run) |
...
```
01 (executed) → 02 → 03 → 04 (executed; soak pending)
                      ↘ 05 (ready) → 06
```
...
| Ready for Guide 05 code? | **Yes, after** bulk soak + capture stopped + Tom says "follow dev guide 05" |
| Ready for Guide 06? | **No** — after Guide 05 |
| Safe during active bulk? | Guide 05 yes; Guide 04 **no** (during impl) |
