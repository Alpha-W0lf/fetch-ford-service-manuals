/**
 * Path resolution for workshop PDFs — keep in sync with src/pathResolve.ts.
 *
 * Handles legacy on-disk folders that use ":" vs "-" (e.g. "1: General Information"
 * vs "1- General Information") without ambiguous basename-only matching.
 */
const fs = require("fs");
 ...
 * Never uses basename-only matching — avoids false positives when the same filename
 * appears in multiple TOC folders.
 */
